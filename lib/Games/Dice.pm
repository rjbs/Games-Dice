...
$Games::Dice::VERSION = '0.99_01';

@Games::Dice::EXPORT_OK = qw(roll roll_array);
...
This method can be imported as a function for backwards compatibility, in which
case it functions as follows:

 use Games::Dice qw(roll);
 roll("2d4+1"); # equivalent to Games::Dice->new(spec => "2d4+1")->roll();

=cut

sub roll {
  return __PACKAGE__->new($_[0])->roll if @_ == 1 and not ref $_[0];
...
C<roll_array> can also be exported, and will behave identically to C<roll> --
context will determine whether a total or a list is returned.  This function is
deprecated and should be avoided.

=cut

sub roll_array { carp "roll_array is deprecated; user roll"; goto &roll }
